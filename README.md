...
> **v2 workspace** — forked from v1 (`cursor/114_1_學校專案/python程式期末專案_美食系統`).  
> **v2 demo:** https://food-map-niu-v2.streamlit.app · **v2 repo:** https://github.com/boson316/food_map_niu_v2  
> v1 demo: https://niu-foodmap.streamlit.app · v1 repo: https://github.com/boson316/niu-foodmap
...
- Default campus center: **NIU main campus** (Shennong Rd.), ~`24.7464°N, 121.7457°E`.
...
| `category` | | 字串，可空 |
| `price_level` | | 1–4 or omit |
| `food_groups` | | string array (optional; auto-classified on load) |
| `regular_opening_hours` | | Google `periods` object (optional) |
| `business_status` | | e.g. `OPERATIONAL` (optional) |

JSON output also includes `open_status_display`, `food_group_display`, `avg_spend_display`.
